...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.20.12
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.20.12
...
require (
	...
	k8s.io/apiserver v0.20.12 // indirect
	k8s.io/client-go v0.20.12 // indirect
	k8s.io/cloud-provider v0.20.12 // indirect
	k8s.io/component-base v0.20.12 // indirect
	k8s.io/component-helpers v0.20.12 // indirect
	k8s.io/csi-translation-lib v0.20.12 // indirect
